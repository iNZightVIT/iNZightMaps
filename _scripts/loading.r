...
## shape file(rds)
l1 = 'C:/Users/yeamin/Desktop/iNZightMaps-dev-integrateplots/data/world.rds'
...
## data set
data.1 = read.csv('C:/Users/yeamin/Desktop/iNZightMaps-dev-integrateplots/data/data.csv')
